...
Enhanced with PyQt6 (opacity animations removed)
"""
    ...
    def start_transmission(self):
        ...
        if output_dir and not os.path.exists(output_dir):
            ...
            if response == QMessageBox.StandardButton.Yes:
                ...
                return
        args = {"target_ip": target_ip, "input_file": input_file,
...
class MainWindow(QMainWindow):
    ...
    def show_about(self):
        QMessageBox.about(self, "About CrypticRoute",
                          ...
                          "<p style='font-size: 10pt; margin-top: 20px;'>Enhanced with PyQt6 (animations removed).</p>")
